...
void ImGui_ImplDX9_RenderDrawListas(ImDrawData* draw_data)
{
...
bool ImGui_ImplDX9_Init(void* hwnd, IDirect3DDevice9* device)
{
	...
	io.RenderDrawListsFn = ImGui_ImplDX9_RenderDrawListas;   // Alternatively you can set this to NULL and call ImGui::GetDrawData() after ImGui::Render() to get the same ImDrawData pointer.
