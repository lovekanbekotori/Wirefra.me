...
namespace SETTINGS
{
	...
	{
		std::string file_path = "C:\\Wirefra.me Configs\\" + file_name + ".cfg";
	...
	{
		CreateDirectory("C:\\Wirefra.me Configs", NULL);
	...
	{
		std::string file_path = "C:\Wirefra.me Configs\\BlankConfig.cfg";
	...
	std::vector<std::string> CSettings::GetConfigs()
	{
		...
		WIN32_FIND_DATA ffd;
		auto directory = "C:\\Wirefra.me Configs\\*";
